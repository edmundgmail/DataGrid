...
--
-- Table structure for table `report_filenames`
--

DROP TABLE IF EXISTS `report_filenames`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `report_filenames` (
...
--
-- Dumping data for table `report_filenames`
--

LOCK TABLES `report_filenames` WRITE;
/*!40000 ALTER TABLE `report_filenames` DISABLE KEYS */;
/*!40000 ALTER TABLE `report_filenames` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-06-06 14:11:18
